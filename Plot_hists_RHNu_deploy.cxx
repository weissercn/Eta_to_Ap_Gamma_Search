void Plot_hists_RHNu_deploy(TString option ){
  ...
  if (option == "All"){ _file0 = TFile::Open("NTuple_X2RHNuGm_all_files_with_materials.root");}
  if (option == "Test"){ _file0 = TFile::Open("NTuple_X2RHNuGm_all_files_with_materials_test.root");}

  TTree * t = (TTree *) _file0->Get("data");

  if (option == "Di" || option == "Test"){ t->Process("Plot_hists_RHNu.C",option);}
  if (option == "All"){ t->Process("Plot_hists_RHNu.C+",option);}
