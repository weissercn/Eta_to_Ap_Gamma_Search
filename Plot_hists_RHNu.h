...
#ifndef Plot_hists_RHNu_h
#define Plot_hists_RHNu_h
...
class Plot_hists_RHNu : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Plot_hists_RHNu(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Plot_hists_RHNu() { }
   ...
   ClassDef(Plot_hists_RHNu,0);
};

#endif

#ifdef Plot_hists_RHNu_cxx
void Plot_hists_RHNu::Init(TTree *tree)
{
...
#endif // #ifdef Plot_hists_RHNu_cxx
