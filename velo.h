...
public:
  ...
  */
  void configIntegral(double dvmin = 0, double sigma = 5,
  ...
  */
  void configDistance(double dvmin = 0, double tol = 1e-10, int itr = 100,
		      bool logt = false);
  ...
  public:
    ...
    */
    ...
    /*
      ...
      \param z:    z-position to evaluate.
    */
    double p(unsigned int idx, double z);
...
public:
  ...
  */
  ...
  /*
    ...
    \param half: -/+1 for the lower/upper VELO half in x.
  */
  double p(unsigned int idx, double z, int half);
  ...
  */
  void configIntegral(double dvmin = 0, double sigma = 5, double step = 1, 
  ...
  */
  void configDistance(double dvmin = 0, double dvmax = 100,
