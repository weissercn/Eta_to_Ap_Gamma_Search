...
void Plot_hists_X2ApGm::SlaveBegin(TTree * /*tree*/)
{
   ...
   std::cout << "Plot_hists_X2ApGm The option is : " << option << std::endl;
...
void Plot_hists_X2ApGm::DiRHNu_Plots(unsigned first_id_test, unsigned second_id_test)
{
...
std::tuple<double, double>  Plot_hists_X2ApGm::DiRHNu_Variables_Calculation(unsigned first_id_test, unsigned second_id_test)
{
...
void Plot_hists_X2ApGm::SingleRHNu_Plots(unsigned mum)
{
...
void Plot_hists_X2ApGm::Plot_Scatter_Graphs()
{
